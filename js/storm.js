/* SBMM Site Explorer — the storm-drainage network (v12, docs/V12_STORM_SPEC.md).
   ...
   the nine grate inlets — Frog Pond → Green Pond → the grates → the junction →
   the Clear Lake outfall. `tools/build_storm_network.py` assembles all of that
   into data/storm_network.json (43 nodes, 25 conduits); this module renders it
