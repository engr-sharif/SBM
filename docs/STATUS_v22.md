...
| S — three pipes + overflow follows them + slider rule | not started | agent S — **start here Monday after the 7 PM reset**; one Opus agent in a worktree, spec §S + §R, addendum: never push, report with the re-recorded numbers |
...
Fable budget at 81 %, resetting Monday 7 PM. An agent round costs more than what was
